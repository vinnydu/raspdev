...
public class ScpTo{
	public static void scpCli(String file1,String context, int port){
		...
		try{
			...
			String lfile=file1;
			System.out.println("file1= "+lfile);
			String user=context.substring(0, context.indexOf('@'));
			context=context.substring(context.indexOf('@')+1);
			String host=context.substring(0, context.indexOf(':'));
			String rfile=context.substring(context.indexOf(':')+1);
